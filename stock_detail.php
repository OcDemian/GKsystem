...
<div class="container">
  <div class="breadcrumb">
    <ul class='breadcrumb_body'>
      ...
      <li class="breadcrumb_body_item">
        <span class="breadcrumb_body_item_last">Акции</span>
      </li>
    </ul>
  </div>
  <h1>Спецпредложение на остатки сварной  балки</h1>
    ...
    <div class="stock_detail_carusel">
      <?for ($i=0; $i < 4; $i++) {?>
        <div class="stock_detail_carusel_item">
          <img class="stock_detail_carusel_item_img" src="/image/stock_detail.png" alt="">
        </div>
      <?}?>
    </div>
  </div>
